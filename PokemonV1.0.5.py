...
while True:
  ...
  while True:
    ...
    input("Press Enter To Continue...")
    print("Press (9. To save and exit)")
    break
  ...
  while True:
    ...
    if freechoice == "6":
      ...
      print("Press (6. For help)")
      input("Press Enter to continue...")
      print("Press (7. To Catch Pokemon (BE AWARE CATCHING A THIRD POKEMON WILL REPLACE YOUR SECOND POKEMON))")
      input("Press Enter To Continue...")
      print("Press (8. To Battle With Your Caught Pokemon)")
      input("Press Enter To Continue...")
      print("Press (9. To save and exit)")
    if freechoice == "7":
      ...
      json_Rattata = '{"hp": 55, "maxhp": 300, "attack": 52, "maxattack": 300, "defence": 55, "maxdefence": 300, "special": "ember", "level": 5, "health": 55, "stage": 5, "type": "fire"}'
      json_Psyduck = '{"hp": 55, "maxhp": 300, "attack": 52, "maxattack": 300, "defence": 55, "maxdefence": 300, "special": "vine whip", "level": 5, "health": 55, "stage": 5, "type": "grass"}'
      json_Pidove = '{"hp": 55, "maxhp": 300, "attack": 52, "maxattack": 300, "defence": 55, "maxdefence": 300, "special": "water cannon", "level": 5, "health": 55, "stage": 5, "type": "water"}'
      ...
      while True:
        if pokeballs > 0:
          ...
          if ifcatch =="N" or ifcatch == "n" or ifcatch == "No" or ifcatch == "no":
            ...
            break
    if freechoice == "8":
      whichpoke = input("Wich Pokemon Do You Want To Use? First Or Second? (Enter 1 or 2)")
...
print(
  f"Your final stats: HP: {pokemon_stats['hp']}, Max HP: {pokemon_stats['maxhp']}, Attack: {pokemon_stats['attack']}, Max Attack: {pokemon_stats['maxattack']}, Defence: {pokemon_stats['defence']}, Max Defence: {pokemon_stats['maxdefence']}, Special: {pokemon_stats['special']}"
)
